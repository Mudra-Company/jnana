      ...
      return {
        profile: {
          ...
          karmaData: karma ? {
            ...
            riskFactors: karma.risk_factors || undefined,
            seniorityAssessment: karma.seniority_assessment || undefined,
            scenario: (karma as any).scenario || undefined,
            roleId: (karma as any).role_id || undefined,
            skillAssessments: (karma as any).skill_assessments || undefined,
            softSkillAssessments: (karma as any).soft_skill_assessments || undefined,
            cultureFit: (karma as any).culture_fit || undefined,
            managerFitSignals: (karma as any).manager_fit_signals || undefined,
            growthAreas: (karma as any).growth_areas || undefined,
            careerAspirations: (karma as any).career_aspirations || undefined,
            alerts: (karma as any).alerts || undefined,
            confidenceOverall: (karma as any).confidence_overall ?? undefined,
          } : undefined,
