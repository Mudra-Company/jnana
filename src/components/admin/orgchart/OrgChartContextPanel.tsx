...
export const OrgChartContextPanel: React.FC<Props> = ({
  ...
  return (
    <aside
      className="w-[340px] shrink-0 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800/40 flex flex-col h-[calc(100vh-220px)] min-h-[500px]"
      aria-live="polite"
    >
      <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100 dark:border-gray-700 shrink-0">
        ...
        <button
          onClick={onToggleCollapsed}
          className="p-1.5 rounded-lg text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-gray-700 dark:hover:text-gray-200"
